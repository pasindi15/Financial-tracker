    ...
    <div class="flex-1 flex items-center justify-center px-6 py-12 bg-slate-50">
        <div class="w-full max-w-md">
            ...
            <div class="bg-white rounded-2xl shadow-xl shadow-slate-200/50 border border-slate-100 p-8">
                ...
                <div class="mt-4 text-red-600 text-sm text-center bg-red-50 rounded-lg py-2 px-3"><?php echo e(session('error')); ?></div>
                <?php endif; ?>
...
<?php /**PATH E:\Projects\Financial Tracker\resources\views/login.blade.php ENDPATH**/ ?>